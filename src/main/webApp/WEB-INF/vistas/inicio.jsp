...
<body>
	...
	<sec:authorize access="hasAuthority('ROL_CLIENTE')">
		<form action="/cliente/busquedaPorTema" method="get">
			<div class="input-group">
				<div class="form-outline">
					<label class="form-label" for="form1">Buscar por tema:</label> <input
						type="search" name="nombreTema" id="nombreTema"
						class="form-control" /> <input type="submit"
						value="Buscar por tema" class="btn btn-primary">
				</div>
			</div>
		</form>
		...
		<form action="/cliente/busquedaPorPalabra" method="get">
			<div class="input-group">
				<div class="form-outline">
					<label class="form-label" for="form1">Buscar por palabra:</label> <input
						type="search" name="palabra" class="form-control" /> <input
